page 50249 "PurchInvLineAPI"
{
    /// <summary>
    /// Date        Name                    Version   Description
    /// 2025.11.20  Business Central AL     001.0     API page for Purch. Inv. Line (table 123)
    /// </summary>

    Caption = 'PurchInvLineAPI';
